...
use core_resources::{
    EntityHandle, LuaWorldState, process_lua_commands,
    sync_entity_state_cache,
};
...
use camera::{
    CameraLookState, apply_cursor_mode, setup_scene_and_camera, toggle_camera_mode,
    update_camera_follow,
    update_camera_look_from_mouse, update_raycast_bridge,
};
use environment::{
    VolumetricFogDebugState, apply_environment_light, publish_volumetric_fog_state_to_lua,
};
use movement::{
    MovementGroundState, apply_player_movement, collect_and_send_input,
    post_physics_vel_y_damp, publish_input_state_to_lua,
};
use npc::{
    attach_capsule_to_new_npcs, attach_model_to_new_npcs, bootstrap_owned_npc_agents, cleanup_unowned_npc_agents,
    drive_npc_animations, send_owned_npc_transforms, sync_npc_net_transform,
    terrain_snap_owned_npcs, update_owned_npc_avoidance,
};
use visuals::{
    ...
    sync_net_transform_to_render, update_crosshair_entity, update_local_player_visibility,
};
use stairs::{
