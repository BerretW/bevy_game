...
/core_net/src/
  ...
  sim.rs                         ServerSimPlugin orchestrace, player/combat/state sync wiring
  sim/lifecycle.rs               Connection/bootstrap observers and replication lifecycle wiring
  sim/players.rs                 Player input cache, trusted transform sync, simulation tick, position history
  sim/weapons.rs                 Timed weapon state runtime (fire/swap/reload helpers)
/host_server/src/
...
/host_client/src/
  ...
  gameplay.rs                    ClientGameplayPlugin orchestrator, stairs/helpers, render/gameplay wiring
  gameplay/bridge.rs             Input bridge, connection bridge, engine command polling
  gameplay/camera.rs             Camera setup, mouse look, cursor mode, player/custom camera follow, raycast bridge
  gameplay/animation.rs          Player locomotion animation state machine, animation registry discovery, Lua animation apply
  gameplay/environment.rs        Environment light apply, fog/volumetric fog debug publish, env light marker/resource
  gameplay/movement.rs           Player movement physics, ground-contact helpers, input send/Lua input bridge
  gameplay/npc.rs                Client NPC visual/capsule attach, ownership bootstrap, transform sync, owned-NPC updates
  gameplay/stairs.rs             Stairs debug publish, local foot IK, terrain snap runtime cache/state
  gameplay/visuals.rs            Player/local/dummy visual attach, render smoothing, crosshair entity resolve
  physics.rs                     ClientPhysicsPlugin orchestrator, physics debug wiring, shared marker types
  physics/attach.rs              Drawable/dummy/collider-object attach orchestration
  physics/collision_toggle.rs    CollisionEnabled recursive collider enable/disable flow
  physics/colliders.rs           Collider construction helpers for drawable/dummy/object collider flows
  physics/navmesh.rs             Navmesh triangle cache resource and rebuild system
  physics/stairs.rs              Generated stairs collider pipeline, IK surface marker, player foot raycast
